...
class QuotacaoItem(models.Model):
    quotacao        = models.ForeignKey(Quotacao, on_delete=models.CASCADE, db_column='quotacao_id', related_name='itens')
    linha           = models.IntegerField(default=1)
    descricao       = models.CharField(max_length=500)
    quantidade      = models.DecimalField(max_digits=18, decimal_places=2, default=1)
    unidade         = models.ForeignKey(Unidade, null=True, blank=True, on_delete=models.SET_NULL, db_column='unidade_id', related_name='quotacao_itens')
